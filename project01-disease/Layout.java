public class Layout {
	...
	static final int POPULATION_PANEL_W = WINDOW_W/3*2-10;
	...
	static final int STATS_PANEL_W = WINDOW_W/3;
	static final int STATS_PANEL_H = 400;
	...
	static final int CONTROL_PANEL_W = WINDOW_W/3;
	...
	static final int SLIDER_PANEL_W = CONTROL_PANEL_W/2 - 6; // 3 each side
	...
	static final int SLIDER_PANEL_RIGHT = CONTROL_PANEL_W/2 + 6;
	...
	static final int SLIDER_W = SLIDER_PANEL_W - 50;
	...
	static final int NUMBER_AREAS = 4;
	static BoundingBox[] BOUNDARIES = new BoundingBox[NUMBER_AREAS];
	
	// Start button
	static final int START_W = 100;
	static final int START_H = 75;
	static final int START_X = CONTROL_PANEL_W/2 - START_W/2;
	static final int START_Y = CONTROL_PANEL_H - 100;
}